...
export function HeroSection() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Auto-play indgangsanimation - max 400ms
      ...
      // Telefon vejrtrækningsanimation - subtil
      gsap.to(phone, {
        y: -4,
        duration: 3,
        ease: 'sine.inOut',
      ...
      // Scroll-drevet udgangsanimation
      const scrollTl = gsap.timeline({
        scrollTrigger: {
          ...
          scrub: 0.5,
          onLeaveBack: () => {
            // Nulstil til synlig ved scroll tilbage til top
      ...
      // INDGANG (0%-30%): Hold fuldt synlig
      // PAUSE (30%-70%): Statisk
      // UDGANG (70%-100%): Animer ud
      scrollTl
        .fromTo(content, 
          { y: 0, opacity: 1 }, 
