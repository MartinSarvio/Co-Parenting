      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            <div className="flex items-center gap-2.5 mb-4">
              <img src="/icon-192.png" alt="Hverdag" className="h-9 w-9 rounded-xl" />
              <span className="text-lg font-bold text-white tracking-tight">Hverdag</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li className="text-white/50">kontakt@hverdag.dk</li>
        ...
        <div className="mt-12 pt-6 border-t border-white/8 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-[12px] text-white/30">
            &copy; {new Date().getFullYear()} Hverdag. Alle rettigheder forbeholdes.
          </p>
